...
//    }
//
//    public OrderDTO toResponseDTO(OrderEntity order) {
//        List<OrderItemDTO> orderItems = order.getOrderItems().stream().map(orderItem -> this.orderItemMapper.toResponseDTO(orderItem)).toList();
